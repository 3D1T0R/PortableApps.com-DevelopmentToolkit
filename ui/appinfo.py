...
class Ui_AppInfoDialog(object):
    def setupUi(self, AppInfoDialog):
        ...
        self.UsesDotNetVerson = QtGui.QComboBox(self.AdvancedGroupBox)
        self.UsesDotNetVerson.setEditable(True)
        self.UsesDotNetVerson.setObjectName("UsesDotNetVerson")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(0, "None")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(1, "1.1")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(2, "2.0")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(3, "3.0")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(4, "3.5")
        self.UsesDotNetVerson.addItem("")
        self.UsesDotNetVerson.setItemText(5, "4.0")
        self.formLayout_7.setWidget(2, QtGui.QFormLayout.FieldRole, self.UsesDotNetVerson)
